...
export const loadGenders = createAction('[Genders] Load Genders');
export const loadGendersSuccess = createAction('[Genders] Load Genders Success', props<{ genders: Gender[] }>());
